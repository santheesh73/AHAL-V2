...
def build_intelligence_schema(session_id: str, session_type: str, scan_result: ScanResult | None) -> dict[str, Any]:
    ...
    base["project_goal"] = clean_sentence(CanonicalOutputGuard.sanitize_text(canonical.product_summary or getattr(getattr(project_brief, "goal", None), "content", purpose.summary or _FALLBACK_TEXT), canonical))
