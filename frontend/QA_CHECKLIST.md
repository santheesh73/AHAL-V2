...
- Confirm the answer does not repeat the same paragraph
- Confirm section blocks are clean and not duplicated
- Evidence chips are short and deduplicated
- Confirm weak domain tags like `ai_hallucination_detection`, `ecommerce`, `crm`, `cms`, `analytics`, `devops`, and `chatbot` do not appear as evidence chips
